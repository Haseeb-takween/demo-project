	...
	return (
		<div className="min-h-screen w-full bg-gray-50 flex flex-col items-center justify-center px-4 py-12">
			...
			<div className="mb-8 flex flex-col items-center gap-3">
				...
				<h1 className="text-2xl font-semibold text-gray-900 tracking-tight">Business Enquiry</h1>
				<p className="text-sm text-gray-500">Fill in the form and we will get back to you shortly</p>
			</div>
